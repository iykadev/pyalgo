...
if __name__ == '__main__':
    print(replace(text4, extractreplacements(grammar5)) == '00011H1111000')
    print(replace(text1, extractreplacements(grammar1)) == 'I bought a bag of apples from my brother.')
